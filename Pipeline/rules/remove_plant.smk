...
rule remove_plant:
	...
	output:
		bamplant1=temporary(f'{output_dir}' + "sra_download/" + "{sample}/{sample}_1_plant.bam"),
		bamplant2=temporary(f'{output_dir}' + "sra_download/" + "{sample}/{sample}_2_plant.bam"),
		sortedplant=temporary(f'{output_dir}' + "sra_download/" + "{sample}/{sample}_sorted_plant.bam"),
