rule download_sample:
    ...
    shell:
        "fasterq-dump --split-files {wildcards.sample} -c {params.C} -b {params.B} -e {params.P} -m {params.M} -O {output_dir}sra_download/{wildcards.sample}/ -p && gzip {output_dir}sra_download/{wildcards.sample}/*"
