...
#To run this script: python3 make_config.py sample_dir path_to_yaml outdir
#Sample dir structure: Data/{Sample}/{Sample}.fq

def make_config(sample_dir, path_to_config, output_dir):
...
def main():
    ...
    make_config(sample_dir, path_to_config, output_dir)
